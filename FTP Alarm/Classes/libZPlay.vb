...
#Region "libzplay.dll interface"
        ...
        <System.Runtime.InteropServices.DllImport("libzplay.dll", EntryPoint:="zplay_GetWaveOutInfoW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        ...
        <System.Runtime.InteropServices.DllImport("libzplay.dll", EntryPoint:="zplay_GetStreamInfoW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
        Private Shared Function zplay_GetStreamInfoW(ByVal objptr As UInteger, ByRef pInfo As TStreamInfo_Internal) As Integer
        End Function


        <System.Runtime.InteropServices.DllImport("libzplay.dll", EntryPoint:="zplay_LoadID3ExW", ExactSpelling:=True, CharSet:=System.Runtime.InteropServices.CharSet.Unicode, SetLastError:=True)>
