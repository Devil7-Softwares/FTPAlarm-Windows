...
Public Module RestAPI
    ...
    Function PostFeedback(ByVal FeedBack As Feedback) As Boolean
        If isNetworkConnected() Then
            Try
                ...
                client.DefaultRequestHeaders.Add("x-apikey", LicenseKeys.GetRestDBAPIKey) '"Keys" Class is where i hold my API keys. Write your own one...
